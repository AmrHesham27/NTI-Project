...
router.post("/sendNewPassword/:otp", userController.sendNewPassword)
router.get("/showProperty/:id", userController.showProperty)
router.post("/search", userController.search)
router.get("/AllProperties", userController.AllProperties)
...
router.post("/editAddr", auth, active, userController.editAddr)
router.post("/addAddr", auth, active, userController.addAdrr)
